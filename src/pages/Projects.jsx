...
const Projects = () => {
  return (
    ...
    <br className='mt-4'/>
      Reflecting on my journey, I take pride in my clear progression and am excited to continue down this path, evolving my abilities as a Full Stack developer. You can browse some of my favourite projects below.
    </p>
    </div>
